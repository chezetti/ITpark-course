...
$tos --url https://net.ton.dev call --abi $DEBOT_NAME.abi.json --sign $DEBOT_NAME.keys.json $DEBOT_ADDRESS setShoppingListCode ShoppingList.decode.json